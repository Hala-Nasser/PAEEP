    ...
    <div class="card card-flush">
        ...
        <div class="card-header align-items-center py-5 gap-2 gap-md-5">
            ...
            <div class="card-toolbar">
                <!--begin::Add customer-->
                <a href="{{ route('achievement.create') }}" class="btn btn-primary">{{ trans('achievement.create_title') }}</a>
                <!--end::Add customer-->
            </div>
            <!--end::Card toolbar-->
        </div>
                    ...
                    <table class="table align-middle table-row-dashed fs-6 gy-5 dataTable no-footer" id="data_table">
                        ...
                        <thead>
                            ...
                            <tr class="text-start text-gray-400 fw-bolder fs-7 text-uppercase gs-0">
                                ...
                                <th class="min-w-150px" style="text-align: start;">{{ trans('general.achievement') }}</th>
                                <th class="min-w-200px" style="text-align: start;">{{ trans('achievement.count') }}</th>
...
@section('js')
    ...
    <script>
        function DeleteAchievement(id, element) {
            Swal.fire({
                title: 'Are you sure?',
                text: "This action will delete selected achievement!",
                icon: 'warning',
        ...
        function performDelete(id, element) {
            axios.delete('{{LaravelLocalization::getCurrentLocale()}}/dashboard/achievement/' + id)
