                        ...
                        <div class="card-body pt-0">
                             ...
                             <div class="mb-10 fv-row">
                                ...
                                <input type="text" class="form-control mb-2"
                                    placeholder="{{ trans('achievement.achievement_title_en') }}" value="" id="title_en" />
                                <!--end::Input-->
                            </div>
                            <!--end::Input group-->
                            <!--begin::Input group-->
                            <div class="mb-10 fv-row">
                                ...
                                <!--begin::Input-->
                                <input type="text" class="form-control mb-2"
                                    placeholder="{{ trans('achievement.achievement_title_ar') }}" value="" id="title_ar" />
                                <!--end::Input-->
                            </div>
                            <!--end::Input group-->
                            <div class="mb-10 fv-row">
                                ...
                                <input type="number" class="form-control mb-2"
                                    placeholder="{{ trans('achievement.count') }}" value="" id="count" />
                                <!--end::Input-->
                            </div>
