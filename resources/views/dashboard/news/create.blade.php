                        ...
                        <div class="card-body pt-0">
                            ...
                            <div class="mb-10 fv-row">
                                ...
                                <input type="text" class="form-control mb-2"
                                    placeholder="{{ trans('news.news_title_en') }}" value="" id="title_en" />
                                <!--end::Input-->
                            </div>
                            <!--end::Input group-->
                            <!--begin::Input group-->
                            <div class="mb-10 fv-row">
                                ...
                                <!--begin::Input-->
                                <input type="text" class="form-control mb-2"
                                    placeholder="{{ trans('news.news_title_ar') }}" value="" id="title_ar" />
                                <!--end::Input-->
                            </div>
                            <!--end::Input group-->
                            ...
                            <div class="mb-10 fv-row">
                                ...
                                <!--begin::Input-->
                                <input type="text" class="form-control mb-2"
                                    placeholder="{{ trans('news.location_en') }}" value="" id="location_en" />
                                <!--end::Input-->
                            </div>
                            <!--end::Input group-->
                            <!--begin::Input group-->
                            <div class="mb-10 fv-row">
                                ...
                                <!--begin::Input-->
                                <input type="text" class="form-control mb-2"
                                    placeholder="{{ trans('news.location_ar') }}" value="" id="location_ar" />
                                <!--end::Input-->
                            </div>
                            <!--end::Input group-->
                            ...
                            <div class="mb-10 fv-row">
                                ...
                                <select class="form-select mb-2" data-control="select2" data-placeholder="Select an option"
                                    id="type">
                                    <option value="news">{{ trans('general.new') }}</option>
                                    <option value="advertisment">{{ trans('general.advertisment') }}</option>
                                </select>
                                <!--end::Select2-->
                            </div>
                            <!--end::Input group-->
