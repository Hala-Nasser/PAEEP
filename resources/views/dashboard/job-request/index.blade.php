                    ...
                    <table class="table align-middle table-row-dashed fs-6 gy-5 dataTable no-footer" id="data_table">
                        ...
                        <thead>
                            ...
                            <tr class="text-start text-gray-400 fw-bolder fs-7 text-uppercase gs-0">
                                ...
                                <th class="min-w-250px" style="text-align: start;">{{ trans('job-request.name') }}</th>
                                <th class="min-w-100px" style="text-align: start;">{{ trans('job-request.email') }}</th>
                                <th class="min-w-100px" style="text-align: start;">{{ trans('job-request.read_status') }}</th>
...
@section('js')
    ...
    <script>
        function DeleteJobRequest(id, element) {
            Swal.fire({
        ...
        function performDelete(id, element) {
            axios.delete('{{LaravelLocalization::getCurrentLocale()}}/dashboard/job-request/' + id)
