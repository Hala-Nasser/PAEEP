                    ...
                    <div class="card card-flush py-4">
                        ...
                        <div class="card-body pt-0">
                            ...
                            <div class="mb-10 fv-row">
                                ...
                                <!--end::Label-->
                                <!--begin::Editor-->
                                <textarea class="form-control my-text-area" id="description_en">{!! $slider->description_en !!}</textarea>
                                <!--end::Editor-->
                            </div>
                            <!--begin::Input group-->
                            <div class="mb-10 fv-row">
                                ...
                                <!--end::Label-->
                                <!--begin::Editor-->
                                <textarea class="form-control my-text-area" id="description_ar">{!! $slider->description_ar !!}</textarea>
                                <!--end::Editor-->
                            </div>
...
@section('js')
    <script>
        function performUpdate() {
            ...
            axios.post('/dashboard/slider/{{$slider->id}}', formData).then(function(response) {
