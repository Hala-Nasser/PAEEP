    ...
    <div class="card card-flush">
        ...
        <div class="card-header align-items-center py-5 gap-2 gap-md-5">
            ...
            <div class="card-toolbar">
                <!--begin::Add customer-->
                <a href="{{ route('visual-library.create') }}" class="btn btn-primary">{{ trans('visual-library.create_title') }}</a>
                <!--end::Add customer-->
            </div>
            <!--end::Card toolbar-->
        </div>
                    ...
                    <table class="table align-middle table-row-dashed fs-6 gy-5 dataTable no-footer" id="data_table">
                        ...
                        <thead>
                            ...
                            <tr class="text-start text-gray-400 fw-bolder fs-7 text-uppercase gs-0">
                                ...
                                <th class="min-w-200px" style="text-align: start;">{{ trans('general.visual_library') }}</th>
                                <th class="min-w-150px" style="text-align: start;">{{ trans('visual-library.description') }}</th>
...
@section('js')
        ...
        $(document).ready(function() {
            $(function() {
                var table = $('#data_table').DataTable({
                    ...
                    ajax: "{{ route('visual-library.index') }}",
                    columns: [{
                            data: 'id',
                            name: 'id'
                        },
    ...
    <script>
        function DeleteVisualLibrary(id, element) {
            Swal.fire({
                title: 'Are you sure?',
                text: "This action will delete selected Visual library!",
                icon: 'warning',
        ...
        function performDelete(id, element) {
            axios.delete('{{LaravelLocalization::getCurrentLocale()}}/dashboard/visual-library/' + id)
