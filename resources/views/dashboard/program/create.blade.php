                        ...
                        <div class="card-body pt-0">
                            ...
                            <div class="mb-10 fv-row">
                                ...
                                <input type="text" class="form-control mb-2"
                                    placeholder="{{ trans('program.program_title_en') }}" value="" id="title_en" />
                                <!--end::Input-->
                            </div>
                            <!--end::Input group-->
                            <!--begin::Input group-->
                            <div class="mb-10 fv-row">
                                ...
                                <!--begin::Input-->
                                <input type="text" class="form-control mb-2"
                                    placeholder="{{ trans('program.program_title_ar') }}" value="" id="title_ar" />
                                <!--end::Input-->
                            </div>
                            <!--end::Input group-->
                        </div>
...
@section('js')
    <script>
        function performStore() {
            ...
            axios.post('{{LaravelLocalization::getCurrentLocale()}}/dashboard/program', formData).then(function(response) {
