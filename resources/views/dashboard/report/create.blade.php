                        ...
                        <div class="card-body pt-0">
                            ...
                            <div class="mb-10 fv-row">
                                ...
                                <input type="text" class="form-control mb-2"
                                    placeholder="{{ trans('report.report_title_en') }}" value="" id="title_en" />
                                <!--end::Input-->
                            </div>
                            <!--end::Input group-->
                            <!--begin::Input group-->
                            <div class="mb-10 fv-row">
                                ...
                                <!--begin::Input-->
                                <input type="text" class="form-control mb-2"
                                    placeholder="{{ trans('report.report_title_ar') }}" value="" id="title_ar" />
                                <!--end::Input-->
                            </div>
                            <!--end::Input group-->
                            ...
                            <div class="mb-10 fv-row">
                                ...
                                <!--end::Label-->
                                <!--begin::Input-->
                                <input type="file" class="form-control mb-2" value="" id="file" />
                                <!--end::Input-->
                            </div>
                            <!--end::Input group-->
...
@section('js')
    <script>
        function performStore() {
            ...
            axios.post('{{LaravelLocalization::getCurrentLocale()}}/dashboard/report', formData).then(function(response) {
