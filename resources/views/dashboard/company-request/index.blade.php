                    ...
                    <table class="table align-middle table-row-dashed fs-6 gy-5 dataTable no-footer" id="data_table">
                        ...
                        <thead>
                            ...
                            <tr class="text-start text-gray-400 fw-bolder fs-7 text-uppercase gs-0">
                                ...
                                <th class="min-w-250px" style="text-align: start;">{{ trans('company-request.name') }}</th>
                                <th class="min-w-100px" style="text-align: start;">{{ trans('company-request.organization_type') }}</th>
                                <th class="min-w-100px" style="text-align: start;">{{ trans('company-request.read_status') }}</th>
...
@section('js')
        ...
        $(document).ready(function() {
            $(function() {
                var table = $('#data_table').DataTable({
                    ...
                    ajax: "{{ route('company-request.index') }}",
                    columns: [{
                            data: 'id',
                            name: 'id'
                        },
    ...
    <script>
        function DeleteCompanyRequest(id, element) {
            Swal.fire({
        ...
        function performDelete(id, element) {
            axios.delete('{{LaravelLocalization::getCurrentLocale()}}/dashboard/company-request/' + id)
