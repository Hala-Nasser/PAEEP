                    ...
                    <div class="right-side">
                            ...
                            <div class="input-text" style="margin-top: -10px">
                                <div class="input-div">
                                    <input type="text" id="volunteer_info" name="volunteer_info"
                                        value="{{ request('volunteered_info') }}"
                        ...
                        <div class="main">
                            ...
                            <div class="input-text" style="margin-bottom: 5px;">
                                <div class="input-div" style="top: -20px;">
                                    <input type="date" id="volunteer_beginning" name="volunteer_beginning"
                                        value="{{ request('volunteer_beginning') }}">
                                </div>
                            </div>
                            <span>{{ trans('website-requests.volunteer_ending') }}</span>
                            <div class="input-text" style="margin-bottom: -20px;">
                                <div class="input-div" style="top: -20px;">
                                    <input type="date" id="volunteer_ending" name="volunteer_ending"
                                        value="{{ request('volunteer_ending') }}">
                                </div>
                            </div>
                            <div class="input-text">
                                <div class="input-div">
                                    <input type="text" id="educational_experience" name="educational_experience"
                                        style="height: 93px;" value="{{ request('educational_experience') }}">
