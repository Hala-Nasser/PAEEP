            ...
            <div class="right_contact">
                <form id="contact-us-form" onsubmit="event.preventDefault(); performStore();">
                 <div class="input_name">
                    <input type="text" placeholder="{{trans('website-requests.full_name')}}" name="full_name" id="full_name">
                    <input type="text" placeholder="{{trans('website-requests.email')}}" name="email" id="email">
                 </div>
